...
/* ./.libs/lt-sfconvert.c - temporary wrapper executable for .libs/sfconvert
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sfconvert - temporary wrapper script for .libs/sfconvert\n", f);
  ...
  fputs ("    echo \"sfconvert:sfconvert:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sfconvert:sfconvert:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sfconvert:sfconvert:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
