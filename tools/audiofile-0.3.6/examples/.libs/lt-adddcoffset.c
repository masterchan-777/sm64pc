...
/* ./.libs/lt-adddcoffset.c - temporary wrapper executable for .libs/adddcoffset
...
const char * LIB_PATH_VALUE   = "/c/sm64/switch/tools/audiofile-0.3.6/libaudiofile/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/c/sm64/switch/tools/audiofile-0.3.6/libaudiofile/.libs:";
const char * TARGET_PROGRAM_NAME = "adddcoffset"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# adddcoffset - temporary wrapper script for .libs/adddcoffset\n", f);
  ...
  fputs ("    echo \"adddcoffset:adddcoffset:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"adddcoffset:adddcoffset:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"adddcoffset:adddcoffset:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/c/sm64/switch/tools/audiofile-0.3.6/libaudiofile/.libs:$PATH\n", f);
  fputs ("\n", f);
